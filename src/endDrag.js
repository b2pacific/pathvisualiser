...
//   const [pos, setPos] = useState({ x: gridRef.current.offsetTop || 6, y: gridRef.current.offsetRight || 100 });
  ...
  function onMouseUp(e) {
    const x = Math.floor(
      ...
      y = Math.floor(
        (e.y - gridRef.current.offsetTop) /
          (gridRef.current.clientHeight / 30)
      );
